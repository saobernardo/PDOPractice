    ...
    <body>
        <div class="div_container">
            ...
            <div class="div_form">
                ...
                <p>Cada jogo, que serão cadastrados no sistemas pelos próprios desenvolvedores ou empresas desenvolvedoras, receberá uma tag equivalente ao seu preço. Um jogo que acabou de ser lançado receberá uma tag da cor verde, custando R$ 15,00 de aluguel pelos três dias. Depois de dois meses de lançamento do produto, ele receberá uma tag amarela, indicando que seu preço de aluguel é de R$ 8,00. Após 4 meses ele receberá uma tag vermelha indicando que o preço do seu aluguel caiu para R$ 5,00 e após um ano de lançamento, para R$ 4,00.</p>
                <p>Caso o jogo que alugou para sua conta não esteja funcionando apropriadamente ou você mude de ideia jogando menos de 30 minutos, você poderá pedir por uma devolução e receberá o valor integral do aluguel na sua carteira para escolher outros jogos em nosso catálogo.</p>
